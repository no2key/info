        ...
        <div>
            <div class="viewad">
                ...
                <div class="viewad-meta">
                    时间：<?php echo ($data["date"]); ?>
                </div>
                <div class="viewad-info">
                    <a target="_blank" href="#">地区：<?php echo ($data["region"]); ?></a>
                    <span>&nbsp;-&nbsp;</span>
                    <a target="_blank" href="#"><?php echo ($data["address"]); ?></a>
                </div>
            </div>
            <div class="viewad-descript">
                <div class="typo-p textwrap">
                    <span>日薪：<?php echo ($data["pay"]); ?></span>
                </div>
                <div class="typo-p textwrap">
                <span>公司：<?php echo ($data["company"]); ?></span>
                </div>
                <div class="typo-p textwrap">
                    详情：
